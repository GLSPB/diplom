...
if(isset($send)){
    $rresult = mysqli_query($connect, "UPDATE `users` SET `Role` = '2', `Name` = 'dfgdfgg', `Surname` = 'dfgdfgg', `Otchestvo` = 'dfgdfgg', `Login` = 'dfgdfgg', `Password` = 'dfgdfgg', `Email` = 'gdfgdfg#@fgdfg.dfgdg' WHERE `users`.`id` = 31;") or die ("Error : ".mysqli_error());
